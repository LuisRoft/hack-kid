...
export function ActorsSection() {
  return (
    <section
      id="clientes"
      className="scroll-mt-[var(--scroll-anchor-offset)] border-t border-border-subtle bg-surface-raised/40"
      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
        ...
        <ul className="mt-12 grid list-none gap-6 p-0 lg:grid-cols-3">
          {audiences.map((item) => (
            <li
              key={item.role}
              className="rounded-[var(--radius-xs)] border border-border-subtle bg-surface-base p-6 lg:p-8"
            >
