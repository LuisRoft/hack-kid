  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
        ...
        >
          Así se siente actuar con ventaja
        </p>

        <blockquote className="mt-6 max-w-3xl font-display text-[clamp(1.25rem,2.5vw,1.75rem)] leading-[1.35] font-normal">
          &ldquo;La lluvia empezó el viernes. El lunes vimos que nuestra zona
          subía de riesgo. Hermes nos pidió revisar medicinas, cargar linternas
          y definir dónde reunirnos si el camino se cortaba. El martes cerró la
          vía. Nuestra familia ya tenía un plan.&rdquo;
        </blockquote>

        <p className="mt-6 text-sm text-text-secondary/80">
          Eso es lo que cambia cuando una alerta se convierte en una decisión
          familiar concreta.
        </p>
      </div>
    </section>
